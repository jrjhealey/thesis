...
\fancypagestyle{augment}{%
 ...
 % \fancyhead[LE,RO]{\slshape \rightmark}
  ...
  \fancyfoot[L]{\raisebox{-0.1cm}{\includegraphics[height=0.5cm, clip, trim={100 100 100 100}]{/Users/joehealey/Documents/Warwick/PhD/Thesis/Thesis_Scaffold/Auglogo.png}}
}
  \renewcommand{\headrulewidth}{0.4pt}% Line at the header visible
  \renewcommand{\footrulewidth}{0.4pt}% Line at the footer visible
}
...
Any time you see the symbol below on a page, you can scan that page, and see the model spring to life on the page! (Note, that due to some rendering limitations and reduced resolution, the augmented reality image may not entirely resemble the image on the page, and in cases where the render would have been too large, the image might have been replaced with a related one for simplicity).
