...
\usetikzlibrary{decorations,
                ...
                shapes,
                arrows}
\tikzset{boximg/.style={remember picture,{Dandelion!60},thick,draw,inner sep=0pt,outer sep=0pt}}
...
\todo[inline]{move table of clustering from the bioinformatics chapter to the appendices}
