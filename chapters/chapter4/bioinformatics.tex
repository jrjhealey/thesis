...
\lhead{\textsf{Chapter IV}}
\rhead{\textsf{Comparative Phylogenetics of PVC Operons}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.84\textwidth, trim={0, 0, 0, 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter4/img/GC_boxplot_with_means.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.84\textwidth, trim={0, 0, 0, 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter4/img/Score_boxplot_with_means.pdf}
	\captionsetup{singlelinecheck=off, justification=justified, font=footnotesize, aboveskip=19pt}
...
\todo[inline]{Run MGB for a selection of closely related genomes, and for photorhabdus. Identify all PVCs from all photo genomes to date. Identify orthologs in a selection of closely related species}
\todo[inline]{Zhang et al \citep{Zhang2012a} posit that PVCs are present in MANY species outside the enterobacteria - examine this further?}
...
\todo[inline]{Nabil: Add a schematic of PVC presence and absence between strains to intro}
\todo[inline]{Make a Sarris/Easyfig type thing to show mosaicism?}
\todo[inline]{Include more details of the parameters of clustering the genes (ID/function etc)}
\todo[inline]{Explain the clustering table, or change to presence/absence and move locus tag info to supp.}
\todo[inline]{add more detail to tree, GC and AAID figure captions (mention median line in GC/AAID}
\todo[inline]{Consider collapsing low support nodes in trees/colour coordination/annotation/show significance of splits}
\todo[inline]{consider merging trees in to 4x4 panels}
\todo[inline]{rename SPECIES Tree to 'consensus' tree}
\todo[inline]{Move explanation of AWC to methods - make it clear its not my own work}
\todo[inline]{annotate heatmaps/figures with the functions of the PVC\# numberings (e.g. "tube"/"spike")}
\todo[inline]{Create more summary figures for the discussion e.g. table of PVC identification criteria}
\todo[inline]{Elaborate on the limitations of the method (e.g. this is parsimony, but could be wrong)}
\todo[inline]{General proof read/strip down of language etc}
