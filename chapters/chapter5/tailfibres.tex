...
\lhead{\textsf{Chapter V}}
\rhead{\textsf{Structure and Function of PVC Tail Fibre-like Genes}}
...
%Analysing these sequences with metal binding prediction tools was unable to generate any particularly informative data, with no standout metal co-ordinating moieties unlike the T4 sequence. For example, with MetalDetector\footnote{\url{http://metaldetector.dsi.unifi.it/}} identifies 6 of the 7 histidines in the T4 fibre tip as likely metal binding residues, whereas for pnf13 only a single cysteine is identified, and for lumt13 a single histidine is identified (though this webserver \emph{only} looks for C and H residue sites). In the case of lumt13, that histidine is present in one of the detected repeats however (highlighted in bold in \vref{lumtrepeats}). For pnf13, the identified cysteine is early in the sequence, and does not correspond to any of the known repeats. Generally however, the repeat sequences in both proteins are enriched in amino acids without any particularly strong affinities for metals. Common metal coordinating amino acids include the sidechains of aspartic and glutamic acid, as well as the aromatic group in histidines and tryptophans. Serines, threonines and tyrosines typically interact via hydroxyl groups, and methionine and cysteine interact via their sulphur moieties \citep{Glusker1999}. Both sequences are rich in aspartic acids.
\clearpage
%2XGF
%---------------------------------------------------------------------------
%No. of Repeats|Total Score|Length  |Diagonal| BW-From|   BW-To|   Level
%         4|     151.39|      30|      34|     137|     167|       1
%---------------------------------------------------------------------------
%90-  118 (31.22/ 8.89)	S...AEAD..GvkAHSHSASA.SSTDLGTKTTSSF.......
%138-  172 (44.96/19.36)	S...TSTN..G..EHSHYIEAwNGTGVGGNKMSSYAIsyraG
%173-  203 (44.93/15.57)	G...SNTNaaG..NHSHTFSF..GTSSAGDHSHSVGI....G
%204-  234 (30.28/ 8.43)	AhthTVAI..G..SHGHTITV.NSTGNTENTVKNIA......
%---------------------------------------------------------------------------
\footnotesize
\captionsetup{singlelinecheck=off, justification=justified, font=footnotesize}
\rowcolors{1}{gray!10}{white}
...
\centering
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.85\textwidth, trim={0 0 0 0 }, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter5/img/pET15b-PVCpnf13_Map.pdf}
        \captionsetup{singlelinecheck=off, justification=centering, font=footnotesize, aboveskip=10pt}
        \caption{}
        \label{pET15pnf}
    \end{subfigure}%
    ...
    \begin{subfigure}{\textwidth}
        \centering
            \includegraphics[width=0.85\textwidth, trim={0 0 0 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter5/img/pET29a-PVCpnf13_Map.pdf}
            \captionsetup{singlelinecheck=off, justification=centering, font=footnotesize, aboveskip=10pt}
            \caption{}
            \label{pET29pnf}
        \end{subfigure}%    
...
\centering
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.80\textwidth, trim={0 0 0 0 }, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter5/img/pET15b-PVClumt13_Map.pdf}
        \captionsetup{singlelinecheck=off, justification=centering, font=footnotesize, aboveskip=10pt}
        \caption{}
        \label{pET15lumt}
    \end{subfigure}%
    ...
    \begin{subfigure}{\textwidth}
        \centering
            \includegraphics[width=0.79\textwidth, trim={0 0 0 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter5/img/pET29a-PVClumt13_Map.pdf}
            \captionsetup{singlelinecheck=off, justification=centering, font=footnotesize, aboveskip=10pt}
            \caption{}
            \label{pET29lumt}
        \end{subfigure}%    
...
Both tagged proteins were able to be expressed well in an overnight culture, using a derivatised \emph{E. coli} BL21(DE3) strain from NEB (``NiCo21") when induced at an OD$_{600 nm}$ of 0.4-0.6. \vrefrange{pnf13expressiontrial}{lumt13expressiontrial} show Western blots using an anti-HIS primary antibody and an anti-mouse/rabbit Horseradish Peroxidase (HRP) conjugate secondary antibody from a time course expression trial. It was not possible to see a Western signal from the C-terminally tagged (pET29) construct for pnf13, and in both cases, greater expression was seen from the pET15b, N-terminal constructs.
...
%\begin{overpic}[width=0.5\textwidth, grid, trim=35 100 20 100, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter5/img/pET15b_expression_trial.pdf}
%	% Lane Labels
%	\put()
%	\put(210, 40){\small $\leftarrow$17 kDa}
%\end{overpic}
\hfill
\begin{figure}[p]
	\centering
...
\rowcolor{gray!10} Lacto-\emph{N}-difucohexaose I & Lactose based "O"-glycans & 
...
\rowcolor{gray!10} $\Delta$UA$\rightarrow$2S-GlucNS & &
...
\vcentralise{\includegraphics[height=0.1cm, width=1.9cm, trim={0 6 0 6}, clip]{mannobiose.png}} \\

\rowcolor{gray!10}Gal-$\beta$1-6-Gal & Tumour antigens and oligosaccharide core structures & 
...
\rowcolor{gray!10} 3'-sialyllactosamine & & 
