...
There is not much to be said for the last gene in this cluster, PVC11. It has had high quality orthology matches to the gp6 major baseplate hub protein of the T4 phage for some time. As a large gene it likely contributes the bulk of the comparatively simple PVC baseplate. Since it is essentially an already solved question, the structures and orthology for this locus will skipped over for the sake of brevity, and the chapter will focus next on other more enigmatic proteins in the last block of the operon.
