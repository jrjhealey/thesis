...
*PVC5 attracts the same 3 homology matches as PVC1, plus 4TV4. }\\
\label{tubehomologs}\\
...
\rowcolor{white!10}                              & 3EAA & T6SS             & Inner sheath protein \\
\rowcolor{white!10} \multirow{-4}{*}{PVC1 \& 5*} & 4TV4 & T6SS             & Inner sheath protein \\
...
\addfloat{comparisons of PVCs2,3,4 to try and understand their paralogy? Same with PVC 1 and 5}
