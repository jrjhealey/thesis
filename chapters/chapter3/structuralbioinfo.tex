...
\vref{tubehomologs} shows a summarised selection of the orthologues which HHPred has picked up over time. The full list of the most recent orthologies detected is not shown for brevity.
...
\begin{subfigure}[H]{\textwidth}
  \includegraphics[width=\textwidth, trim={41 0 60 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter3/img/PVC1_homolog_comparison.png}
...
\clearpage
\myparagraph{Structural comparisons of multiplied tube proteins}\label{duptrip}
...
\thispagestyle{IHA-fancy-style}
\centering
\includegraphics[width=0.75\textwidth, trim={50 30 100 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter3/img/PVC9_gp25.png}
\captionsetup{singlelinecheck=off, justification=justified, font=footnotesize, aboveskip=10pt}
...
\myparagraph{Identifying subtle hallmarks of potential spike ``PAAR" proteins}
...
\end{figure}
\clearpage
\myparagraph{PVC11 as the major baseplate structural component}
...
\myparagraph{PVC12, an enigmatic nucleotide binding protein?}
...
\begin{figure}[h]
 \thispagestyle{IHA-fancy-style}
 \centering
   \includegraphics[width=\textwidth, trim={90 0 90 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter3/img/tapemeasures.png}
 \captionsetup{singlelinecheck=off, justification=justified, font=footnotesize, aboveskip=10pt}
