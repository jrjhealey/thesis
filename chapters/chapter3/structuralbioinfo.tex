...
\addfloat{figure of the tubes (maybe just a top down) for T6SS, pyocin, T4. Might be needed for orienting the reader}
...
\myparagraph{Structural comparisons of duplicated and triplicated tube proteins}
...
\begin{figure}[h]
 \thispagestyle{augment}
 \frame{\includegraphics[width=\textwidth, trim={0 0 0 0}, clip]{/Users/joehealey/Documents/Warwick/PhD/Thesis/chapters/chapter3/img/PVC1vsPVC5.png}}
 \put(-80,155){\small Interior Aspect}
 \put(-80,45){\small  Reverse Aspect}
 \put(-260,-10){\small PVC1}
 \put(-140,-10){\small PVC5}
 \put(-70,90){%
  \begin{tikzpicture}[scale = .3]%
    \draw (0,0)  -- (0,3)  node [midway] {\AxisRotator[x=0.15cm,y=0.3cm,->,rotate=-90]};%
  \end{tikzpicture}%
 }
 \put(-38,101){$180^{\circ}$}
 \captionsetup{singlelinecheck=off, justification=justified, font=footnotesize, aboveskip=20pt}
 \caption[PVC1 and PVC5 paralog conservation comparison]{\textsc{\normalsize Comparisons of sequence conservation between inner sheath paralogues.}\vspace{0.1cm} \newline Models of PVC1 and PVC5 are shown, coloured according to their per-columns sequence conservation (as per the sequence alignments in Appendix \ref{bioinformatics_appendix}. Front and rear rotations of the models are shown. This highlights the lack of significant structural differences and generally high sequence conservation, though PVC1 is slightly more variable. Conservation is rendered from high (green), to low (red), as per the inset scalebar.}
	\label{PVC1vsPVC5}
\end{figure}
