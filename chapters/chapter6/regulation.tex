...
An unexpected observation from the microscopy is the appearance of a number of elongated cells in several of the panels. Subjectively, it seemed that the extended cell morphology correlated to some degree with GFP fluorescence, though examples of non-fluorescent cells can be seen too.

A number of the previous panels demonstrate these phenotypes:

\begin{figure}[p]
  
\hspace{1cm}\begin{subfigure}{\linewidth}
  \begin{subfigure}{0.4\linewidth}
    ...
    % Define scope of anchors for boxes?
      \begin{scope}[x=(img.south east),y=(img.north west)]
        \node[draw, minimum height=0.8cm, minimum width=1.5cm] (B1) at (0.6,0.87) {};
     \end{scope}
    \end{tikzpicture}
  \end{subfigure}\hspace{2cm}\begin{subfigure}[t]{0.4\linewidth}
    \begin{tikzpicture}[boximg]
      \node (img1) {\includegraphics[width=\linewidth, trim={550 1400 250 0} ,clip]{TT01U1_72HR_1_GREEN-crunch-lighter-resample.pdf}};
  ...
  \caption*{\textbf{\emph{P. luminescens} TT01 ``Unit 1" Panel 1, 72 Hours}}
\vspace{1cm}

%%%%%%%%%%%%%%%%

  \begin{subfigure}{\linewidth}
  \hspace{1cm}\begin{subfigure}{0.4\linewidth}
    \begin{tikzpicture}[boximg]
    % Main image as a node
      \node[anchor=south west] (img) {\includegraphics[width=\linewidth]{THAIU1_72HR_4_GREEN-crunch-lighter-resample.pdf}};
    % Define scope of anchors for boxes?
      \begin{scope}[x=(img.south east),y=(img.north west)]
        \node[draw, minimum height=0.8cm, minimum width=0.7cm] (B1) at (0.5,0.65) {};
        \node[draw, minimum height=1.4cm, minimum width=0.7cm] (B2) at (0.3,0.35) {};
     \end{scope}
    \end{tikzpicture}
  \end{subfigure}\hspace{2cm}\begin{subfigure}[t]{0.4\linewidth}
    \begin{tikzpicture}[boximg]
      \node (img1) {\includegraphics[width=\linewidth, trim={700 1100 400 450} ,clip]{THAIU1_72HR_4_GREEN-crunch-lighter-resample.pdf}};
      \draw (img1.south west) rectangle (img1.north east);
    \end{tikzpicture}  
    \begin{tikzpicture}[boximg]
      \node (img2) {\rotatebox{90}{\includegraphics[height=\linewidth, trim={450 350 1200 600} ,clip]{THAIU1_72HR_4_GREEN-crunch-lighter-resample.pdf}}};
...
Additionally, it may be noticed that many of the cells, regardless of length, begin to form phase-bright points apically, reminiscent of a forespore. These structures are not spores however (as \emph{Photorhabdus} is non-sporulative), but instead are likely protein crystal depositions which are produced later in the growth process to act as nutrient depots for nematodes that would be grazing on the bacteria `in the wild'.
